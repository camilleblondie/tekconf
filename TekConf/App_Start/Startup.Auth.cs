    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseTwitterAuthentication(
               consumerKey: "WMqgWxc30Ndbcr4Cx9TDodQte",
               consumerSecret: "PrJwWVFDBm4qmTYS5HjZPcL5uiNSdxnYedewVRBqfff3WjvsFW");

            app.UseFacebookAuthentication(
               appId: "810088045774217",
               appSecret: "e25e1e55739b354152fbe7b3a1dc360e");

            app.UseGoogleAuthentication(new GoogleOAuth2AuthenticationOptions()
            {
                ClientId = "117290815538-tqcm5u5sp65u4sv4cc9rpag0qrqi9bip.apps.googleusercontent.com",
                ClientSecret = "0KdDRLfbjos1q9TpwTUSOyTs"
            });
        }
    }
}